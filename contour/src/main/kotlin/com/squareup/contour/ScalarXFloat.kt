...
/**
 * Represents a [Float] on the x axis that is positioning agnostic, meaning that it isn't defined in
 * relation to the edge of a view (e.g. dip values, widths, center points).
 */
@JvmInline
value class ScalarXFloat(
  override val value: Float
) : LeftRightCompatibleXFloat, StartEndCompatibleXFloat {
  inline operator fun plus(other: Int) = ScalarXFloat(value + other)
  inline operator fun plus(other: ScalarXInt) = ScalarXFloat(value + other.value)
  ...
  inline operator fun minus(other: Int) = ScalarXFloat(value - other)
  inline operator fun minus(other: ScalarXInt) = ScalarXFloat(value - other.value)
  ...
  inline operator fun times(other: Int) = ScalarXFloat(value * other)
  inline operator fun times(other: ScalarXInt) = ScalarXFloat(value * other.value)
  ...
  inline operator fun div(other: Int) = ScalarXFloat(value / other)
  inline operator fun div(other: ScalarXInt) = ScalarXFloat(value / other.value)
  ...
  inline fun toInt() = ScalarXInt(value.toInt())
}
