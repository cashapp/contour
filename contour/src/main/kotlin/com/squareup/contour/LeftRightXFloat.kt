...
/**
 * Represents a [Float] on the x axis that is compatible with absolute positioning, meaning that it
 * can be used in relation to the left or right edge of a view.
 */
interface LeftRightCompatibleXFloat : XFloat

/**
 * Represents a [Float] on the x axis that with an absolute position, meaning that it is defined in
 * relation to the left or right edge of a view.
 */
@JvmInline
value class LeftRightXFloat(override val value: Float): LeftRightCompatibleXFloat {
  inline operator fun plus(other: Int) = LeftRightXFloat(value + other)
  inline operator fun plus(other: LeftRightCompatibleXInt) = LeftRightXFloat(value + other.value)
  ...
  inline operator fun minus(other: Int) = LeftRightXFloat(value - other)
  inline operator fun minus(other: LeftRightCompatibleXInt) = LeftRightXFloat(value - other.value)
  ...
  inline operator fun times(other: Int) = LeftRightXFloat(value * other)
  inline operator fun times(other: LeftRightCompatibleXInt) = LeftRightXFloat(value * other.value)
  ...
  inline operator fun div(other: Int) = LeftRightXFloat(value / other)
  inline operator fun div(other: LeftRightCompatibleXInt) = LeftRightXFloat(value / other.value)
  ...
  inline fun toInt() = LeftRightXInt(value.toInt())
}
